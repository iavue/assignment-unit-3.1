...
let favoriteFoods = ['sushi', 'kbbq', 'ribeye', 'eggs']
...
console.log('STRETCH TODO: Last animal is', animalArray[animalArray.length-1]);
...
console.log('Added a new food to end,', favoriteFoods);
